...
contents in CFD, I will only focus on the certain methods that I am specialized in, while general
concepts will also be discussed. The major method discussed in this document will be the Finite
...
problems. This is a big gap between the ``fluid'' and the ``solid'' community. Although the trend is
